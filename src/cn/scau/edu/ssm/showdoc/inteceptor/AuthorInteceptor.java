...
public class AuthorInteceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
		...
		if(url != null && (url.contains("operateVoucherHandle.action") || url.contains("queryByName.action") || url.contains("index.jsp") || url.contains("insertVoucherInfo.action") || url.contains("register.jsp") || url.contains("login.jsp") || url.contains("checkVoucher.action") || url.contains("/jsp/") || url.contains("/js/") || url.contains("/images/") || url.contains("/css/") || url.contains("/fonts/") || url.contains("getCaptchar.action") || url.contains("getVcode.action")))
			return true;
